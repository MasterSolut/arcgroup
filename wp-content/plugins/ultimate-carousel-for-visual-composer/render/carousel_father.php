...
class WPBakeryShortCode_vc_carousel_father extends WPBakeryShortCodesContainer {
	...
	protected function content( $atts, $content = null ) {
		...
		ob_start(); ?>
		<section class="tdt-slider slider <?php echo $theme; ?>" id="tdt-slider-<?php echo $some_id ?>" style="width: <?php echo $width; ?>;" data-slick='{"arrows": <?php echo $arrow; ?>, "autoplaySpeed": 2000, "dots": <?php echo $dot; ?>, "autoplay": <?php echo $autoplay; ?>, "slidesToShow": <?php echo $slide_visible; ?>, "slidesToScroll": <?php echo $slide_scroll; ?>, "fade": <?php echo $effect; ?>}'>
		    <?php echo $content; ?>
		</section>
